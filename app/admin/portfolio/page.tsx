      ...
      <Section title="Skills">
          ...
          <div key={i} className="flex gap-2 mb-1">
            <input
              ...
              onChange={(e) => {
                ...
                tech[i] = e.target.value
                setData({ ...data, skills: { ...data.skills, tech } })
              }}
            />
            <RemoveButton
              onClick={() => {
                const tech = data.skills.tech.filter((_, j) => j !== i)
                setData({ ...data, skills: { ...data.skills, tech } })
              }}
            />
          </div>
        ...
        <AddButton
          onClick={() =>
            setData({
              ...data,
              skills: { ...data.skills, tech: [...data.skills.tech, ''] },
            })
          }
        />
        ...
        {data.skills.communication.map((item, i) => (
          <div key={i} className="flex gap-2 mb-1">
            <input
              ...
              value={item}
              onChange={(e) => {
                const communication = [...data.skills.communication]
                communication[i] = e.target.value
                setData({
                  ...data,
            ...
            <RemoveButton
              onClick={() => {
                const communication = data.skills.communication.filter(
                  (_, j) => j !== i
                )
                setData({
                  ...data,
